...
int main()
{
    ...
    int Dimension;           // No. of spatial dimensions
        ...
        planet planet1(0.000003,1.,0.0,0.0,0.0,6.28,0.); //Earth, testing to find circular orbit
        ...
        double initialVelocity_x = planet1.velocity[0];
        double initialVelocity_y = planet1.velocity[1];

        binary_vv.EulerEarthSun(IntegrationPoints, FinalTime, planet1.position[0], planet1.position[1], initialVelocity_x, initialVelocity_y);
